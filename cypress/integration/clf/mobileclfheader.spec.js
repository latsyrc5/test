...
describe('CLF Mobile Header Test Suite', () => {
    ...
    it('should hide ubc logo', () =>{
        cy.get('[id="ubc7-header"] > .container > .span1 > #ubc7-logo').should('have.css', 'display', 'none')
    })

    it('ubc banner redirects to ubc.ca', () =>{
